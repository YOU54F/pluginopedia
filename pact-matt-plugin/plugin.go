...
func (m *mattPluginServer) ConfigureInteraction(ctx context.Context, req *plugin.ConfigureInteractionRequest) (*plugin.ConfigureInteractionResponse, error) {
	...
	log.Println("[INFO] Request:", config.Request.Body)
	log.Println("[INFO] Response:", config.Response.Body)

	expectedRequest = config.Request.Body
	requestedResponse = config.Response.Body
	log.Println("[INFO] expectedRequest:", expectedRequest)
	log.Println("[INFO] requestedResponse:", requestedResponse)
	if err != nil {
	...
	log.Println("[INFO] interactions:", interactions)
