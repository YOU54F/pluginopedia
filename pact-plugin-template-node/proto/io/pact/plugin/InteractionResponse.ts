...
export enum _io_pact_plugin_InteractionResponse_MarkupType {
  COMMON_MARK = 0,
  HTML = 1,
}
...
export interface InteractionResponse {
  ...
  'interactionMarkupType'?: (_io_pact_plugin_InteractionResponse_MarkupType | keyof typeof _io_pact_plugin_InteractionResponse_MarkupType);
  'partName'?: (string);
}
...
export interface InteractionResponse__Output {
  ...
  'interactionMarkup': (string);
  'interactionMarkupType': (keyof typeof _io_pact_plugin_InteractionResponse_MarkupType);
  'partName': (string);
}
